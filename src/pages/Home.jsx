      ...
      <div className="w-full max-w-md flex flex-col items-center justify-center flex-shrink-0">
        ...
        <div className="w-full space-y-3">
          ...
          <button
            ...
            className="group w-full p-6 rounded-3xl bg-gradient-to-br from-amber-500/90 via-orange-500/90 to-red-500/90
                       backdrop-blur-xl border border-white/10
                       hover:from-amber-600/90 hover:via-orange-600/90 hover:to-red-600/90
                       transform hover:scale-[1.02] transition-all duration-200
          ...
          >
            <div className="flex items-center justify-between">
              <div className="text-left">
                ...
                <h2 className="text-2xl font-bold text-white mb-1 tracking-tight">Kickstart</h2>
                <p className="text-amber-100/80 text-sm">Photo intake for Free People</p>
              </div>
              <div className="text-white/80 text-3xl">→</div>
            </div>
          </button>
